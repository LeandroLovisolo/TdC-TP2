...
Como lo planteamos anteriormente, los enlaces submarinos y los routers que asignan prioridad baja a las respuestas de paquetes ICMP muestran ambos un ZRTT alto, pero con la diferencia de que los routers que asignan una prioridad diferente hacen que el nodo siguiente tenga un ZRTT más bajo que el resto. Por este problema, la utilización de un umbral negativo para las mediciones de los ZRTT relativos, en este caso -1, resulta efectivo para descartar estos casos, en especial el del primer nodo externo.
